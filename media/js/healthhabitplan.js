...
jQuery(function() {
    ...
    jQuery('#fridge').droppable({
        drop: function(event, ui) {
            ...
            var storeX = offset.left - fridgeOffset.left;
            var storeY = offset.top - fridgeOffset.top;
            saveMagnetPosition(item.attr('id').split('-')[1], storeX, storeY);
    ...
    jQuery('.magnet-trash').click(function() {
        deleteMagnet(jQuery(this));
    });
});
