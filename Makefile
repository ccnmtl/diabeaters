...
jshint: node_modules/jshint/bin/jshint
	./node_modules/jshint/bin/jshint --config=.jshintrc media/js/healthhabit* media/js/dragdropreorder.js

jscs: node_modules/jscs/bin/jscs
	./node_modules/jscs/bin/jscs media/js/healthhabit* media/js/dragdropreorder.js
